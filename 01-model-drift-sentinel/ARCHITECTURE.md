...
| **MCP server (optional, GCP-native deployments)** | Anthropic Model Context Protocol | OIDC + Agent Identity | Allows the bank's agents to query drift status as a tool — interlocks with [Project 04 — AgentWatch](../04-agent-reliability-console/) |
